...
- User asks to install or run Open Design, self-host Claude Design, "setup open design" → invoke `/setup-open-design`
- User asks to create a video composition, render HTML to video, build a HyperFrames clip, "write html render video", captions/TTS for video → invoke `/hyperframes`
